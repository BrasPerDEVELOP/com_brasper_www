...
└── modules/               # Módulos de la aplicación
    ├── auth/              # Autenticación
    ├── commercial/        # Ventas, leads, tickets, procesos...
    ├── company/           # Áreas, cargos, roles, usuarios...
    ├── global/            # Monedas, tipos de documento, razones sociales...
    └── projects/          # Proyectos, fases, bloques, lotes, unidades...
```
