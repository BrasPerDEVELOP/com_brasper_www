/**
 * Código telefónico internacional (E.164).
 * El backend espera el valor del enum (prefijo, ej. "+51"), no el nombre del miembro ("pe").
 */

/** Prefijos telefónicos válidos (valor del enum PhoneCode en el backend). */
export type PhoneCode =
  | '+93' | '+355' | '+213' | '+376' | '+244' | '+1268' | '+54' | '+374' | '+61' | '+43' | '+994'
  | '+1242' | '+973' | '+880' | '+1246' | '+375' | '+32' | '+501' | '+229' | '+975' | '+591' | '+387'
  | '+267' | '+55' | '+673' | '+359' | '+226' | '+257' | '+855' | '+237' | '+1' | '+238' | '+236'
  | '+235' | '+56' | '+86' | '+57' | '+269' | '+242' | '+506' | '+385' | '+53' | '+357' | '+420'
  | '+45' | '+253' | '+1767' | '+1809' | '+593' | '+20' | '+503' | '+240' | '+291' | '+372' | '+268'
  | '+251' | '+679' | '+358' | '+33' | '+241' | '+220' | '+995' | '+49' | '+233' | '+30' | '+1473'
  | '+502' | '+224' | '+245' | '+592' | '+509' | '+504' | '+852' | '+36' | '+354' | '+91' | '+62'
  | '+98' | '+964' | '+353' | '+972' | '+39' | '+1876' | '+81' | '+962' | '+7' | '+254' | '+686'
  | '+850' | '+82' | '+965' | '+996' | '+856' | '+371' | '+961' | '+266' | '+231' | '+218' | '+423'
  | '+370' | '+352' | '+853' | '+261' | '+265' | '+60' | '+960' | '+223' | '+356' | '+692' | '+222'
  | '+230' | '+52' | '+691' | '+373' | '+377' | '+976' | '+382' | '+212' | '+258' | '+95' | '+264'
  | '+674' | '+977' | '+31' | '+64' | '+505' | '+227' | '+234' | '+389' | '+47' | '+968' | '+92'
  | '+680' | '+970' | '+507' | '+675' | '+595' | '+51' | '+63' | '+48' | '+351' | '+974' | '+40'
  | '+250' | '+1869' | '+1758' | '+1784' | '+685' | '+378' | '+239' | '+966' | '+221' | '+381'
  | '+248' | '+232' | '+65' | '+421' | '+386' | '+677' | '+252' | '+27' | '+211' | '+34' | '+94'
  | '+249' | '+597' | '+46' | '+41' | '+963' | '+886' | '+992' | '+255' | '+66' | '+670' | '+228'
  | '+676' | '+1868' | '+216' | '+90' | '+993' | '+688' | '+256' | '+380' | '+971' | '+44' | '+598'
  | '+998' | '+678' | '+379' | '+58' | '+84' | '+967' | '+260' | '+263'

/** Opciones para select: value = prefijo (lo que envía la API), label = país + prefijo. */
export const PHONE_CODES: { value: PhoneCode; label: string }[] = [
  ...
  { value: '+1268', label: 'Antigua y Barbuda (+1268)' },
  ...
  { value: '+1869', label: 'San Cristóbal y Nieves (+1869)' },
  { value: '+1758', label: 'Santa Lucía (+1758)' },
  { value: '+1784', label: 'San Vicente y las Granadinas (+1784)' },
  ...
  { value: '+1868', label: 'Trinidad y Tobago (+1868)' },
  ...
  { value: '+379', label: 'Ciudad del Vaticano (+379)' },
