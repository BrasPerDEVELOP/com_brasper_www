<template>
  <section
    id="agenda"
    class="relative bg-gradient-to-br from-azure-600 via-azure-600 to-azure-700 px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24"
  >
        ...
        <div class="order-2 flex h-full flex-col justify-center xl:order-1">
          <div class="rounded-2xl border border-white/20 bg-white/95 p-8 shadow-2xl backdrop-blur-sm sm:p-10 lg:p-12 xl:rounded-3xl xl:p-14">
            <div class="text-center xl:text-left">
              <h2 class="mb-6 text-4xl font-bold leading-tight text-slate-800 sm:mb-8 sm:text-5xl md:text-6xl xl:text-7xl">
                {{ t('landing_schedule_transfer_title') }}
              </h2>
              <p class="mb-8 text-xl leading-relaxed text-slate-600 sm:mb-10 sm:text-2xl">
                {{ t('landing_schedule_transfer_description') }}
              </p>

              <div class="space-y-4 sm:space-y-5">
                <div class="flex items-center justify-center space-x-4 xl:justify-start">
                  <div class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-azure-100 sm:h-10 sm:w-10">
                    <svg class="h-5 w-5 text-azure-600 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 20 20">
                      <path
                        fill-rule="evenodd"
                  ...
                  <span class="text-base font-medium text-slate-700 sm:text-lg">
          ...
          <div class="rounded-2xl border border-white/20 bg-white/95 p-8 shadow-2xl backdrop-blur-sm sm:p-10 lg:p-12 xl:rounded-3xl xl:p-14">
            <form class="space-y-5 sm:space-y-6" @submit.prevent="handleSendWhatsApp">
              <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-6">
                <div class="space-y-3">
                  <label for="transferDate" class="block text-base font-semibold text-slate-700">
                  ...
                  <input
                    ...
                    :min="today"
                    required
                    class="w-full rounded-lg border border-slate-300 px-4 py-3 text-base transition-all duration-200 focus:border-transparent focus:ring-2 focus:ring-azure-500"
                  />
                </div>

                <div class="space-y-3">
                  <label for="amount" class="block text-base font-semibold text-slate-700">
                    {{ t('landing_schedule_amount') }}
                  </label>
                  <div class="relative">
                    <span class="absolute left-4 top-1/2 -translate-y-1/2 text-base font-semibold text-slate-500">
                      {{ currencySymbol }}
                    </span>
                    <input
                      id="amount"
                      ...
                      step="0.01"
                      placeholder="0.00"
                      class="w-full rounded-lg border border-slate-300 py-3 pl-12 pr-4 text-base transition-all duration-200 focus:border-transparent focus:ring-2 focus:ring-azure-500"
                    />
                  </div>
                </div>
              </div>
              ...
              <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-6">
                <div class="space-y-3">
                  <label for="dniCpf" class="block text-base font-semibold text-slate-700">
                ...
                <div class="space-y-3">
                  <label for="fullNames" class="block text-base font-semibold text-slate-700">
              ...
              <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-6">
                <div class="space-y-3">
                  <label for="phone" class="block text-base font-semibold text-slate-700">
                ...
                <div class="space-y-3">
                  <label for="email" class="block text-base font-semibold text-slate-700">
              ...
              <div class="space-y-3">
                <label for="currencyRange" class="block text-base font-semibold text-slate-700">
                ...
                <select
                  ...
                  class="w-full rounded-lg border border-slate-300 bg-white px-4 py-3 text-base transition-all duration-200 focus:border-transparent focus:ring-2 focus:ring-azure-500"
                >
              ...
              <div class="pt-4">
                <button
                  type="submit"
                  class="flex w-full items-center justify-center rounded-lg bg-gradient-to-r from-azure-600 to-cyan-500 px-8 py-4 text-base font-semibold text-white transition-all duration-300 hover:scale-105 hover:from-azure-700 hover:to-cyan-600"
                >
