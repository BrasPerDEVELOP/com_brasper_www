      ...
      <div class="overflow-visible rounded-xl border border-slate-200 px-3 py-2.5 shadow-sm sm:border-slate-300 sm:py-2 sm:shadow-lg">
        ...
        <div class="flex items-center gap-2">
          <input
            ...
            inputmode="decimal"
            autocomplete="off"
            :class="variant === 'banner' ? 'min-w-0 flex-1 py-1 pl-2 text-xl font-semibold text-black focus:outline-none sm:text-2xl' : 'min-w-0 flex-1 rounded-lg border px-3 sm:px-4 py-3 text-lg sm:text-xl  focus:outline-none focus:ring-2 '"
            placeholder="300"
